...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('pemesanan.tumpeng.checkout', $produk->slug) }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="quantity">Jumlah Orang (Minimal 10)</label>
                <input type="number" name="quantity" id="quantity" min="10" value="10" required>
            </div>
            <div class="form-group">
