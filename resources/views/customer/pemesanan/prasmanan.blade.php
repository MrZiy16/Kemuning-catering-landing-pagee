...
<body>
    <x-navbar></x-navbar>
    <div class="container">
        <h2>Paket Prasmanan Tersedia</h2>
        <div class="row">
            @forelse ($produk as $item)
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('pemesanan.prasmanan.detail', $item->slug) }}" class="btn">Lihat Detail</a>
                    </div>
                </div>
            @empty
                <p class="no-products">Belum ada paket prasmanan yang tersedia.</p>
            @endforelse
        </div>
    </div>
</body>
