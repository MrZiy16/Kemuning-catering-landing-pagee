        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div class="flex-grow-1">
                        <div class="text-muted text-uppercase small">Rata-rata Transaksi</div>
                        <div class="fw-bold fs-5">Rp {{ number_format($rataRataTransaksi ?? 0, 0, ',', '.') }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-5">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <h6 class="text-success">Top Menu</h6>
                    <div id="top-menu" class="mb-3 small">
