        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 bg-gradient-info">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h6 class="text-primary mb-2">Rata-rata Transaksi</h6>
                            <h3 class="mb-0 fw-bold text-primary">Rp {{ number_format($summaryData['average_transaction'], 0, ',', '.') }}</h3>
                            <small class="text-primary">per pesanan</small>
                        </div>
                        <div class="flex-shrink-0">
