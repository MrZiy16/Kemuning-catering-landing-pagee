    ...
    <div class="modern-card">
        <div class="modern-card-body">
            <form action="{{ route('admin.transaksi.update', $transaksi->id_transaksi) }}" method="POST">
                ...
                <div class="form-section">
                    <label class="modern-label">Alamat Pengiriman</label>
                    <div class="input-icon" data-icon="📍">
                        <textarea name="alamat_pengiriman" 
                                  class="modern-textarea input-with-icon @error('alamat_pengiriman') is-invalid @enderror" 
                                  rows="3" 
                                  required 
                                  placeholder="Masukkan alamat lengkap pengiriman...">{{ old('alamat_pengiriman', $transaksi->alamat_pengiriman) }}</textarea>
                    </div>
