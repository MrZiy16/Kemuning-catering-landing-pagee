        ...
        <div class="card-body">
            ...
            @else
                <div class="alert alert-success">
                    <strong>Selamat!</strong> Pembayaran online Anda telah berhasil diproses.
                </div>
            @endif
            ...
            @if($payment->method === 'offline')
                <div class="alert alert-warning">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=6281234567890&text=Halo%2C%20saya%20ingin%20konfirmasi%20pembayaran%20ID%3A%20{{ $payment->master_transaction_id }}" 
            ...
            @else
                @if($payment->masterTransaction->remaining_amount > 0)
                    <div class="alert alert-info">
                        <h6>Masih Ada Sisa Pembayaran</h6>
                        <p>Anda masih memiliki sisa pembayaran sebesar <strong>Rp {{ number_format($payment->masterTransaction->remaining_amount, 0, ',', '.') }}</strong></p>
                        <p>Silakan lanjutkan pembayaran di menu pesanan saya untuk menyelesaikan transaksi Anda.</p>
                    </div>
                @else
                    <div class="alert alert-success">
